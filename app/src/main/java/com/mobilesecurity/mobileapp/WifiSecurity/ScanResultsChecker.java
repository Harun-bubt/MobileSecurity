...
public class ScanResultsChecker extends BroadcastReceiver {
    ...
    public void onReceive(Context ctx, Intent intent) {
        ...
        try {
            ...
            Log.e("WifiSecurity", "Null pointer exception when handling networks. Wi-Fi was probably suddenly disabled after a scan", npe);
        }
    }
    ...
    private void checkResults(List<ScanResult> scanResults) {
        ...
        if (networkList == null) {
            Log.i("WifiSecurity", "WifiManager did not return any configured networks. This is "+
        ...
        for (WifiConfiguration network : networkList) {
            ...
            if (networkSafety == AccessPointSafety.TRUSTED) {
                Log.i("WifiSecurity", "Enabling " + network.SSID);
