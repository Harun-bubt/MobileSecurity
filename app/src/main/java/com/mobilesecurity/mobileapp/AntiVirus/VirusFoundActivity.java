...
public class VirusFoundActivity extends Activity {
        ...
        findViewById(R.id.btnDelete).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!FullscanActivity.infectedFiles.isEmpty()) {

                            for (int i = 0; i < FullscanActivity.infectedFiles
                                    .size(); i++) {

                                File file = new File(FullscanActivity.infectedFiles
                                        .get(i));
                                ...
                                if (b) {
                                    Toast.makeText(
                                            ...
                                            FullscanActivity.infectedFiles.get(i)
                                                    + " delete successfully.",
        ...
        findViewById(R.id.btnLogs).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!FullscanActivity.scanedFiles.isEmpty()) {

                            ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                                    VirusFoundActivity.this,
